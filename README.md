...
为了帮助开发者理解如何从零开始构建 H5 聊天应用，我们提供了一个简化的学习项目 **[learn-h5-chat](/learn-h5-chat)**。
...
### 学习路径
- 📖 [学习项目 README](./learn-h5-chat/README.md)
- 🎯 基础聊天界面构建
- 🔌 AI API 集成（OpenAI / Gemini）
- 🌐 Vercel 部署

### 项目对比

| 特性 | Dual AI Chat | Learn H5 Chat |
|------|--------------|---------------|
| 复杂度 | 🔴 高 | 🟢 低 |
| 功能完整度 | 🔴 完全 | 🟡 基础 |
| 学习难度 | 🔴 难 | 🟢 简单 |
